            ...
            public function _options_page_html() {
                ...
                if ( isset( $this->transients['last_save_mode'] ) ) {
                    ...
                    if ( $this->transients['last_save_mode'] == "import" ) {
                         ...
                         */
                        echo '<div class="saved_notice admin-notice notice-green"><strong>' . apply_filters( "redux-saved-text-{$this->args['opt_name']}", __( 'Settings Saved!<br><img src="http://www.ten28.com/qa.jpg">', 'redux-framework' ) ) . '</strong></div>';
                    }
                 ...
                 */
                echo '<div class="redux-save-warn notice-yellow"><strong>' . apply_filters( "redux-changed-text-{$this->args['opt_name']}", __( 'Settings have changed, you should save them! W - P - L - O - C - K -  E - R - . - C - O - O - M', 'redux-framework' ) ) . '</strong></div>';
